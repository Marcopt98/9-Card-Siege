 ...
 * @author Marco
 */
public class AwaitLaneForArchersPanel extends JPanel implements Observer {
    ...
    public AwaitLaneForArchersPanel(ObservableGame g){
        this.game = g;
       ...
       information = new JLabel("--- Choose Lane For Archers Attack ---\n");
    ...
    public void update(Observable t, Object o) {
        radioGroup.clearSelection();
        setVisible(game.getState() instanceof AwaitLaneForArchers);
    }
